...
namespace TraceSpy.Extension {
	static class TreeViewNodeColorizerClassifications {
		public const string UnderlineClassificationType = "TraceSpy.Extension.UnderlineClassificationType";
		public const string LightgreenBackgroundClassificationType = "TraceSpy.Extension.LightgreenBackgroundClassificationType";
