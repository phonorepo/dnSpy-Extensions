...
namespace TraceSpy.Extension {
	...
	static class Constants {
		// Use unique names
		public const string Color1_ClassificationTypeName = "TraceSpy.Extension.Color1";
		public const string Color2_ClassificationTypeName = "TraceSpy.Extension.Color2";
